...
static const MyVec2 FIRST_BAR_POS = MyVec2(20.0f, 14.0f);
static const float BAR_DIST = 10.0f;
...
void PlayerInfo::init(Font& font)
{
	...
	m_progBars[PROG_BAR_HEALTH].init("", MyVec2(), m_textures[TEXTURE_HEALTH_BAR_FORE], m_textures[TEXTURE_HEALTH_BAR_BACK], MyVec2(1.5, 1));
	m_progBars[PROG_BAR_MANA].init("", MyVec2(), m_textures[TEXTURE_MANA_BAR_FORE], m_textures[TEXTURE_MANA_BAR_BACK], MyVec2(1.5, 1));
	m_progBars[PROG_BAR_EXP].init("", MyVec2(), m_textures[TEXTURE_EXP_BAR_FORE], m_textures[TEXTURE_EXP_BAR_BACK], MyVec2(1.5, 1));

	// Label widgets
	m_labels[LABEL_HEALTH].init("", MyVec2(), font, "", MyColor(1, 1, 1), 0.9f);
	m_labels[LABEL_MANA].init("", MyVec2(), font, "", MyColor(1, 1, 1), 0.9f);
	m_labels[LABEL_EXP].init("", MyVec2(), font, "", MyColor(1, 1, 1), 0.9f);
	m_labels[LABEL_GOLD].init("", MyVec2(), font, "", MyColor(1, 1, 1), 1.0f);
	m_labels[LABEL_LEVEL].init("", MyVec2(), font, "", MyColor(1, 0, 0), 1.0f);
}
...
{
	{
		...
		m_labels[LABEL_LEVEL].setText("Level " + toString(player.getLevel()));
	}
	
	{
		...
		m_labels[LABEL_HEALTH].setPos(pos + 0.5f * (m_progBars[PROG_BAR_HEALTH].getSize() - m_labels[LABEL_HEALTH].getSize()) + MyVec2(5, -1));
		...
		m_labels[LABEL_MANA].setPos(pos + 0.5f * (m_progBars[PROG_BAR_MANA].getSize() - m_labels[LABEL_MANA].getSize()) + MyVec2(5, -1));
		...
		m_labels[LABEL_EXP].setPos(pos + 0.5f * (m_progBars[PROG_BAR_EXP].getSize() - m_labels[LABEL_EXP].getSize()) + MyVec2(5, -1));
		m_labels[LABEL_EXP].render(spriteBatch);

		pos.y += m_progBars[PROG_BAR_EXP].getSize().y + BAR_DIST / 2.0f;
		m_labels[LABEL_LEVEL].setPos(pos);
		m_labels[LABEL_LEVEL].render(spriteBatch);
