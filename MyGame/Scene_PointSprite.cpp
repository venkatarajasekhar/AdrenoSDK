...
BOOL CSample::InitShaders()
{
    // Create the point sprite shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Assets/Shaders/PointSprites.vs",
                                                      "Assets/Shaders/PointSprites.fs",
                                                      &m_hParticleShader,
...
BOOL CSample::Initialize()
{
    ...
    if( FALSE == resource.LoadFromFile( "Assets/Textures/PointSprites.pak" ) )
        return FALSE;
