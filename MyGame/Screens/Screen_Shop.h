...
private:
	...
	enum
	{
		...
		// Item avatar
		TEXTURE_ITEM_ACOLYTE_STAFF,
		TEXTURE_ITEM_ARCANE_BOOTS,
		TEXTURE_ITEM_BOOTS_OF_SPEED,
		TEXTURE_ITEM_BROAD_SWORD,
		TEXTURE_ITEM_CLAYMORE,
		TEXTURE_ITEM_DEMON_EDGE,
		TEXTURE_ITEM_DIVINE_RAPIER,
		TEXTURE_ITEM_HEALING_POTION,
		TEXTURE_ITEM_LIFE_WARD,
		TEXTURE_ITEM_LIGHT_CALVARY_HAT,
		TEXTURE_ITEM_PHASE_BOOTS,
		TEXTURE_ITEM_POWER_TREADS,
		TEXTURE_ITEM_QUARTER_STAFF,
		TEXTURE_ITEM_SACRED_RELIC,
